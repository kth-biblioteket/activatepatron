...
require_once('/myits/vendor/autoload.php');
...
try {
    ...
    $oidc->setRedirectURL(html_entity_decode("https://" . $_SERVER['HTTP_HOST'] . "/activatepatron/login.php?language=$language"));
	...
	if(isset($_SESSION['kth_id']) && $_SESSION['kth_id'] != "") {
		...
		header("location: /activatepatron/index.php?language=$language");
	}
